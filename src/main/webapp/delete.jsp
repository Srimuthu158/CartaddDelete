...
try {
	System.out.println("Welcome to Delete Process");
    ...
    String deleteSql = "DELETE FROM images2 WHERE id = ?";
...
%>
        ...
        <head>
            ...
            <script>
                ...
                window.location.href = "cart.jsp"; // Redirect to display page after deletion
            </script>
        </head>
        <body>
            <h2>Image Deleted</h2>
